...
MDFN_HIDE extern const uint8 overflow_add_table[];
MDFN_HIDE extern const uint8 overflow_sub_table[];
MDFN_HIDE extern uint8 sz53_table[];
MDFN_HIDE extern uint8 sz53p_table[];
MDFN_HIDE extern uint8 parity_table[];
